...
import 'mocks/sliderScreenTest.mocks.dart';
...
void main() {
  /// Blocs
  late SliderScreenBloc sliderScreenBloc;
  ...
  _createBlocs() {
    sliderScreenBloc = SliderScreenBloc();
    loginBloc = LoginBloc(
      ...
      child: MultiRepositoryProvider(
        ...
        child: MaterialApp(
          ...
          home: MultiBlocProvider(
              providers: _createBlocProviders(), child: SliderScreenLayout()),
        ),
      ),
    );
  }

  testWidgets('Test slider screen', (WidgetTester tester) async {
    ...
    final signUpButton = find.byKey(Key(Keys.instance.signUpButton));
    final loginButton = find.byKey(Key(Keys.instance.sliderLoginButton));
