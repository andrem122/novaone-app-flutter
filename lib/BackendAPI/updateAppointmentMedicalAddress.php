<?php
    ...
    $query = "UPDATE appointments_appointment_medical SET address = :address, city = :city, zip = :zip WHERE appointment_base_ptr_id = :object_id;";
    
    // query the database and echo results
    $parameters = array(':address' => $address, ':city' => $city, ':zip' => $zip, ':object_id' => $object_id);
